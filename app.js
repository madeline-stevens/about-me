...
while (attempts > 0) {
  var answer = parseInt(prompt ('You have four attempts to guess how many bones Maddy has broken?'));
...
while (guessesLeft > 0) {
  ...
  if (guessesLeft > 0) { //get out of the while loop???
    ...
    if (guessesLeft === 0) {
      alert ('And you are out of guesses!');//message if there are attempts left
    }
  }
